...
- [ ] T003 [W2] [US2] Generate src/assets/icons/apple-touch-icon.png (180x180) and icon-maskable-{192x192,512x512}.png (navy background, shell at about 70% of the canvas, cropped so no straight cut edge shows).
